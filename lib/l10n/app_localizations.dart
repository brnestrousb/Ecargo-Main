...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginAsTitle.
  ///
  /// In en, this message translates to:
  /// **'Login as?'**
  String get loginAsTitle;
  ...
  /// No description provided for @loginAsSender.
  ///
  /// In en, this message translates to:
  /// **'Sender'**
  String get loginAsSender;
}
