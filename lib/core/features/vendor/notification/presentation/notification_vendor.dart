...
class VendorsNotificationScreen extends StatefulWidget {
  const VendorsNotificationScreen({super.key});

  @override
  State<VendorsNotificationScreen> createState() => _NotificationScreenState();
}

class _NotificationScreenState extends State<VendorsNotificationScreen> {
