...
//   try {
//     final response = await auctionRemoteVendorDataSource.getAllAuctions();
//     // Akses response['data']['data'] untuk mendapatkan list auction
//     final List<dynamic> auctionsJson = response['data']?['data'] ?? [];
//     return auctionsJson.map((json) => Auction.fromJson(json)).toList();
//   } on Exception catch (e) {
//     logger.e('Error fetching auctions: $e');
//     rethrow; // biarkan FutureBuilder menangani error
//   }
// }
  ...
  //   auctionRemoteVendorDataSource = AuctionRemoteVendorDataSourceImpl(dio);
  //   _auctionsFuture =
  //       auctionRemoteVendorDataSource.getAllAuctions().then((data) {
  //     final List<dynamic> auctionsJson = data['data'];
  //     return auctionsJson
        ...
        body: SafeArea(
          child: FutureBuilder<List<Auction>>(
            ...
            builder: (context, snapshot) {
              ...
              // Jika ada data, tampilkan daftar lelang
              return SingleChildScrollView(
                child: Column(
                  children: [
                    const SizedBox(height: 20),
                    ...
                    // Daftar Lelang
                    ...auctions.map((auction) => _AuctionItemCard(
                          auction: auction,
                          onTap: () {
          ...
          //                   onPressed: () {
          //                     setState(() {
          //                       _auctionsFuture = auctionRemoteVendorDataSource
          //                           .getAllAuctions()
          //                           .then((data) {
          //                         final List<dynamic> auctionsJson =
          //                             data['data'];
